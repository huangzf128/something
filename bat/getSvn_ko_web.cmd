...
set svnUrl=https://10.83.240.217/svn/kobutsu/sizpp_web/src
rem set startDate=2020-02-10
set startDate=2020-05-11
set "preA=A       "
set "preM=M       "
set "preM1= M      "

set localJavaPath=D:\Develop\Tools\STS-3.9.11\workspace\sizppWeb\src
set localClassPath=D:\Develop\Tools\STS-3.9.11\workspace\sizppWeb\target
set outputPath=CRmateWeb
...
rem	echo %%a
	...
	echo f | xcopy /y !localClassPath!!realPath:main\java=classes! !outputPath!!realPath:main\java=classes!
)
